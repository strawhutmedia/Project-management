...
// QuickBooks OAuth connect flow. Owner-only (requireOwner — which also
// covers Caroline, see migration 136). The callback is hit by the
// owner's browser after authorizing at Intuit (session cookie rides
// along on the top-level redirect), and a CSRF state cookie guards it.
